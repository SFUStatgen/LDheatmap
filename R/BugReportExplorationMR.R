...
# Second part, the spaces being coloured when not desired #
grid.edit(gPath("ldheatmap", "heatMap"))
...
MyHeatmap <- LDheatmap(CEUSNP, genetic.distances = CEUDist,
                       color = grey.colors(20), flip = TRUE)
LDheatmap.highlight(MyHeatmap, 1, 15, col = "blue", fill = NA, lwd =3, flipOutline = FALSE, crissCross = FALSE)
LDTest(CEUSNP, genetic.distances = CEUDist,
       color = grey.colors(20), flip = TRUE)

str(movedGenemap$LDheatmapGrob$children$heatMap$children$heatmap)
movedGenemap$LDheatmapGrob$children$heatMap$children$heatmap$x
movedGenemap$LDheatmapGrob$children$heatMap$children$heatmap$y
##############################################################
